  ...
  function adjustTextForMobile() {
    if (window.innerWidth <= 700) {
      document.getElementById("text_big").innerHTML =
        "Ich bin ein 17-Jähriger aus Veracruz, Mexiko, der sich leidenschaftlich für Cybersicherheit interessiert und durch YouTube und Online-Kurse lernt. Ich benutze Kali Linux und lerne Python für Cybersicherheitszwecke. Zu meinen Hobbys gehören Videospiele und das Vertiefen von IT-Sicherheitswissen. Inspiriert von der Serie Mr. Robot möchte ich mein Studium mit guten Noten abschließen, mir meinen ersten Job im IT-Bereich sichern und unabhängig werden. Trotz der schulischen Anforderungen übe ich in meiner Freizeit weiter und habe ein Zertifikat in diesem Bereich erworben.";
