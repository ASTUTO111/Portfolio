...
function adjustTextForMobile() {
  if (window.innerWidth < 700) {
    document.getElementById("Abaut_text").innerHTML = "Hallo, ich bin ein 17-Jähriger, der am 12.11.2006 in Veracruz, Mexiko, geboren wurde. Ich spezialisiere mich auf Cybersicherheit durch YouTube-Videos und Online-Kurse. Das Betriebssystem, das ich benutze, ist KaliLinux; früher habe ich Parrot benutzt. Derzeit lerne ich, wie man...";
  }
}
