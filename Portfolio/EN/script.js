...
function adjustTextForMobile() {
  if (window.innerWidth < 700) {
    document.getElementById("Abaut_text").innerHTML =
      "Hello, I am a 17-year-old who was born in Veracruz, Mexico on the date of 11/12/2006. I am specializing in cybersecurity through YouTube videos as well as online courses. The OS that I use is KaliLinux; I used to use Parrot. Currently, I am learning how to use...";
  }
}
