...
function adjustTextForMobile() {
  if (window.innerWidth < 700) {
    document.getElementById("Abaut_text").innerHTML =
      "Hola, soy un joven de 17 años que nació en Veracruz, México, el 11/12/2006. Me especializo en ciberseguridad a través de videos de YouTube y cursos en línea. El sistema operativo que uso es KaliLinux; solía usar Parrot. Actualmente, estoy aprendiendo cómo usar...";
  }
}
